...
class Sammy {
	...
	public static function run() {
		if( !static::$route_found ) {
            ...
            Router::preDispatch($sammy->get_uri(false));
		}
	...
	public static function process($route, $type) {
        ...
        /*
        if( $extension_test == '.' . $extension ) $sammy->format = $extension;
        else $sammy->format = 'html';
        */

        $sammy->format = ( $extension_test == '.' . $extension )? $extension: 'html';
